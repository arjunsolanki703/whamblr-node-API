...
module.exports = function (collection) {
	...
	console.log("Mongo URL Raj", process.env.MONGO_URI);

	//if (process.env.MONGO_URI) {
	// Mongo adapter
	const MongoAdapter = require("moleculer-db-adapter-mongo");

	//schema.adapter = new MongoAdapter("mongodb://admin-dashboarddevdb:w%40h!!Rxyy@44.237.32.177:27017/admin-dashboard");
